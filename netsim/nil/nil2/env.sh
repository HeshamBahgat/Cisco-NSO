...
export PATH=${NCS_DIR}/netsim/confd/bin:/root/nso-5.1/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
export PACKAGE_NETSIM_DIR=../../../packages/cisco-ios-cli-3.0/netsim
